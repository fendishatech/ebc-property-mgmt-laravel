...
@section('content')
    <div class="w-full flex items-center justify-center bg-slate-100">
        <form class="w-full md:w-1/3 my-8 rounded-lg bg-white" action="{{ url('/items_store/' . $storeItem->id) }}"
            method="POST">
            @csrf
            @method('PATCH')
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" type="number"
                            name="quantity" min="1" value="{{ $storeItem->quantity }}">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            id="shelf" name="shelf" type="number" min="1" value="{{ $location['shelf'] }}"
                            required>
                    </div>
                    <div>
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="box" name="box" type="number" min="1" value="{{ $location['box'] }}"
                            required>
                    </div>
                    <div>
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="row" name="row" type="number" min="1" value="{{ $location['row'] }}"
                            required>
                    </div>
                    <div>
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="cell" name="cell" type="number" min="1" value="{{ $location['cell'] }}"
                            required>
                    </div>
                </div>
