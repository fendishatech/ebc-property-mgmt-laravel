...
<html>
    ...
    <body>
        <!-- Header -->
        <nav
            class="h-[100px] shadow-lg px-6 py-2 flex justify-between items-center"
        >
            <!-- Logo -->
            <div class="flex items-center">
                <img
                    class="w-[80px] h-[80px]"
                    src="{{ url('/images/ebc-logo.png') }}"
                    alt="Ebc logo"
                />
            ...
            <div class="flex items-center justify-center gap-4">
                ...
                <ul class="flex items-center text-[18px] font-bold">
                    <li
                        class="px-6 active text-red-700 py-2 hover:bg-red-600 hover:text-white rounded"
                    >
                        <a href="/home">Home</a>
                    </li>
                    <li
                        class="px-6 py-2 text-red-700 hover:bg-red-600 hover:text-white rounded"
                    >
                        ...
                        >
                            <div class="py-1 px-2" role="none">
                                ...
                                >
                                    <button
                                        type="submit"
                                        class="block w-full px-4 py-2 text-left rounded text-md font-bold bg-red-600 text-white"
                                        role="menuitem"
                                        tabindex="-1"
                                        id="menu-item-3"
                                    >
